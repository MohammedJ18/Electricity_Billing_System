...
public class CalculateBill extends JFrame implements ActionListener {
    ...
    CalculateBill() throws ClassNotFoundException {
        ...
        try (Connection con = Conn.connect();
                PreparedStatement pr = con.prepareStatement("select * from customer where meter = '" + c1.getSelectedItem() + "'");) {
    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == b1) {
            ...
            int total_bill = 0;
            try (Connection con = Conn.connect();
                    PreparedStatement pr = con.prepareStatement("select * from tax");) {
